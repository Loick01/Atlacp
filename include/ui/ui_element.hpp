...
class UiTextElement : public UiElement
{
    private:
        std::string m_text;
        // TTF_Font in UiTextElement < UiElement < ScreenDrawable < Drawable (TextureController has a Map<TextureKey,TTF_Font)
    ...
    public:
        UiTextElement(TextureController& textureController, const ElementKey& key, 
